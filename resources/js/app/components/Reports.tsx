...
import { Miembro, Persona } from "./mockData"; // Import types if needed, or adjust to actual types
...
export function Reports({ members, personas }: ReportsProps) {
  // Use passed `members` instead of mock `miembros`
